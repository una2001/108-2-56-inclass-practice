...
# 是否來自107或108學屆
str_detect(studentIds, "107|108") #要不要向量
```
...
year1 <- str_extract(olddate, regex_pattern1)
westernYear1 <- as.integer(year1)+1639
str_replace(olddate, regex_pattern1, 
            as.character(westernYear1)) -> olddate_reformat
datefinal1 <- lubridate::ymd(olddate_reformat)
datefinal1
```
